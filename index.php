...
<body>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                    ...
                    <br><br>
                    LƯU Ý :<br>
                    - AD sẽ không duyệt những cfs có từ ngữ không chuẩn mực, xúc phạm quá mức với nhau đâu nhé!
                    Có thể confession sẽ bị trễ vì con ad lười hoặc bận 
                    <br>
                    - Khi gửi ảnh kèm theo vui lòng chỉ gửi ảnh minh họa vui vẻ, tuyệt đối không gửi ảnh các bạn hoặc người nào đó lên, không gửi ảnh thô thiển,  
    ...
    <footer class="text-center text-lg-start">
        <div class="text-center p-3">
            © 2022 Copyright:
            <a class="text-dark" href="https://www.thcsminhdamwars.ga">thcsminhdamwars.ga</a> 
            | Coded By:
