    ...
    <div class="">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th scope="row" class="col-5">'.$name.'</th>
                <th scope="row" class="col-5"><a href="mailto:'.$email.'" target="_blank">'.$email.'</a></th>
                <th scope="row" class="col-5"><a href="tel:'.$phone.'" target="_blank">'.$phone.'</a></th>
                <th scope="row" class="col-5"><a href="'.$fbLink.'" target="_blank">'.$fbLink.'</a></th>
                <td id="message" class="col-5"><h5><b>'.$message.'</b></h5></td>
